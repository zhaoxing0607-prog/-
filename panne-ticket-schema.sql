...
-- Migration compatible si la table a déjà été créée.
alter table public.toolmanager_panne_tickets
add column if not exists component text;
update public.toolmanager_panne_tickets
set component = 'À renseigner'
